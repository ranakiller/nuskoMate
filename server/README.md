...
Pick any hard-to-guess string (e.g. a UUID) and add it to KV:

```bash
wrangler kv key put --binding=LICENSES "NUSK-3F9A-7C21-B8E4" "Ali Travels (paid 2026-06)"
```
...
## Revoking a key
```bash
wrangler kv key put --binding=LICENSES "NUSK-3F9A-7C21-B8E4" "revoked"
# or delete it entirely:
wrangler kv key delete --binding=LICENSES "NUSK-3F9A-7C21-B8E4"
```

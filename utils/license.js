...
(function () {
  ...
  const FEATURES = ["ocr", "father", "bulk", "batch", "vaccine", "issuedate", "reload", "overlay", "autorules", "autoclick", "autofill", "fillrules", "autoselect", "workflows", "urlshift", "groups", "brnrequest", "translaterules", "mvtotals", "talabcopy", "autodatepicker"];
